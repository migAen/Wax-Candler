export const fancyCombinations = [
    ...
    subcategories: [
      {
        family_id: 1,
        name: "Floral (General)",
        example_notes: ["Rose", "Gardenia"],
      },
      {
        family_id: 2,
        name: "Tropical Fruits",
        example_notes: ["Mango", "Coconut"],
      },
    ],
  },
  {
    ...
    subcategories: [
      {
        family_id: 1,
        name: "Floral (General)",
        example_notes: ["Jasmine", "Lily of the Valley"],
      },
  ...
  },
  {
    ...
    description:
      "A smoky, woody concoction of Pine, Cedarwood, and Black Pepper",
    subcategories: [
      {
        family_id: 4,
        name: "Woody (General)",
        example_notes: ["Cedarwood", "Pine"],
      },
  ...
  },
  {
    ...
    description:
      "Cedarwood, Patchouli, and Cinnamon, for a deep, spicy, and woody aroma",
    subcategories: [
  ...
  // Citrus & Floral (combining family_id 2 for Fruity, and family_id 1 for Floral)
  {
    ...
    description:
      "Bergamot, Lemon, and Tuberose create a zesty yet elegant floral aroma",
    subcategories: [
  ...
  },
  {
    ...
    subcategories: [
      { family_id: 2, name: "Citrus", example_notes: ["Orange"] },
      {
        family_id: 1,
        name: "Floral (General)",
        example_notes: ["Jasmine", "Lavender"],
      },
    ],
  },
  {
    ...
    description:
      "Grapefruit, Freesia, and Ylang-Ylang, for a lively, fragrant atmosphere",
    subcategories: [
    ...
    subcategories: [
      {
        family_id: 3,
        name: "Gourmand",
        example_notes: ["Coffee", "Chocolate"],
      },
  ...
  },
  {
    ...
    name: "Caramel Woods",
    description:
      "A warm, decadent fusion of Caramel, Sandalwood, and Tonka Bean",
    subcategories: [
  ...
  },
  {
    ...
    subcategories: [
      { family_id: 4, name: "Woody (General)", example_notes: ["Pine"] },
      {
        family_id: 10,
        name: "Green Fougere",
        example_notes: ["Moss", "Fresh Grass"],
      },
    ],
  },
  ...
  },
  {
    ...
    description:
      "Rosewood, Amber, and Vanilla creating a sweet, woody floral balance",
    subcategories: [
  ...
  },
  {
    ...
    description:
      "A fresh aquatic and green blend of Seaweed, Green Leaves, and Marine Notes",
    subcategories: [
  ...
  },
  {
    ...
    subcategories: [
      { family_id: 9, name: "Aquatic", example_notes: ["Seaweed"] },
      {
        family_id: 10,
        name: "Green Fougere",
        example_notes: ["Fresh Grass", "Sage"],
      },
    ],
  },
  ...
  // Leather & Woody (combining family_id 8 for Leather, and family_id 4 for Woody)
  {
    ...
    subcategories: [
      { family_id: 8, name: "Leather", example_notes: ["Leather"] },
      {
        family_id: 4,
        name: "Woody (General)",
        example_notes: ["Birch Tar", "Cedarwood"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "A creamy and comforting mix of Sandalwood, Amber, and Vanilla",
    subcategories: [
      { family_id: 4, name: "Woody (General)", example_notes: ["Sandalwood"] },
      { family_id: 5, name: "Warm Amber", example_notes: ["Amber", "Vanilla"] },
    ],
  ...
  },
  {
    ...
    description:
      "A deep and aromatic mix of Cedarwood, Nutmeg, and Black Pepper",
    subcategories: [
      { family_id: 4, name: "Woody (General)", example_notes: ["Cedarwood"] },
  ...
  },
  {
    ...
    description:
      "A fresh and breezy combination of Sea Breeze, Mint, and Fresh Grass",
    subcategories: [
      { family_id: 9, name: "Aquatic", example_notes: ["Sea Breeze"] },
  ...
  },
  {
    ...
    description:
      "A fresh aquatic and green blend of Saltwater, Green Leaves, and Fern",
    subcategories: [
  ...
  },
  {
    ...
    description:
      "A spicy and creamy fusion of Sandalwood, Cinnamon, and Vanilla",
    subcategories: [
      { family_id: 4, name: "Woody (General)", example_notes: ["Sandalwood"] },
      { family_id: 11, name: "Warm Spicy", example_notes: ["Cinnamon"] },
      { family_id: 5, name: "Warm Amber", example_notes: ["Vanilla"] },
  ...
  },
  {
    ...
    description:
      "A soothing and floral blend of Amber and Rose with a touch of Tonka Bean",
    subcategories: [
      { family_id: 5, name: "Warm Amber", example_notes: ["Amber"] },
      { family_id: 1, name: "Floral (General)", example_notes: ["Rose"] },
      { family_id: 5, name: "Warm Amber", example_notes: ["Tonka Bean"] },
  ...
  },
  {
    ...
    subcategories: [
      { family_id: 3, name: "Spicy Oriental", example_notes: ["Cinnamon"] },
      {
        family_id: 5,
        name: "Warm Amber",
        example_notes: ["Amber", "Tonka Bean"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "A sweet and decadent combination of Caramel, Amber, and Vanilla",
    subcategories: [
      { family_id: 3, name: "Gourmand", example_notes: ["Caramel"] },
      { family_id: 5, name: "Warm Amber", example_notes: ["Amber", "Vanilla"] },
    ],
  ...
  },
  {
    ...
    description:
      "A refreshing aquatic and green blend of Sea Breeze, Pine, and Fern",
    subcategories: [
      { family_id: 9, name: "Aquatic", example_notes: ["Sea Breeze"] },
  ...
  },
  {
    ...
    name: "Woody Chypre",
    description:
      "A complex and earthy blend of Oakmoss, Vetiver, and Patchouli",
    subcategories: [
      {
        family_id: 7,
        name: "Woody Chypre",
        example_notes: ["Vetiver", "Oakmoss"],
      },
      { family_id: 4, name: "Woody (General)", example_notes: ["Patchouli"] },
    ],
  },
  {
    ...
    description:
      "A fresh and tangy fusion of Peach, Tomato Leaf, and Green Leaves",
    subcategories: [
      { family_id: 2, name: "Stone Fruits", example_notes: ["Peach"] },
  ...
  },
  {
    ...
    name: "Gourmand Woods",
    description:
      "A sweet yet grounded blend of Vanilla, Tonka Bean, and Cedarwood",
    subcategories: [
      {
        family_id: 3,
        name: "Gourmand",
        example_notes: ["Vanilla", "Tonka Bean"],
      },
      { family_id: 4, name: "Woody (General)", example_notes: ["Cedarwood"] },
    ],
  },
  {
    ...
    description:
      "A smoky and spicy combination of Tobacco, Leather, and Black Pepper",
    subcategories: [
      {
        family_id: 8,
        name: "Tobacco Leather",
        example_notes: ["Tobacco", "Leather"],
      },
      { family_id: 11, name: "Piquant Spicy", example_notes: ["Black Pepper"] },
    ],
  },
    ...
    subcategories: [
      {
        family_id: 13,
        name: "Sweet Balsamic",
        example_notes: ["Benzoin", "Tonka Bean"],
      },
  ...
  },
  {
    ...
    description:
      "A fresh and vibrant fusion of Muguet, Freesia, and Fresh Grass",
    subcategories: [
      {
        family_id: 1,
        name: "Green Floral",
        example_notes: ["Muguet", "Freesia"],
      },
      { family_id: 10, name: "Grassy", example_notes: ["Fresh Cut Grass"] },
    ],
  },
